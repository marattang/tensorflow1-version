...
tf.compat.v1.disable_eager_execution() # 그래프를 안만들진 않는다.
            # 즉시 실행 모드?
...
# sess = tf.Session() # tensorflow 2버전에서는 session이 제공되지 않음.
sess = tf.compat.v1.Session() # tensorflow 2버전에서 tensorflow 1을 실행하려면 사용한다.
